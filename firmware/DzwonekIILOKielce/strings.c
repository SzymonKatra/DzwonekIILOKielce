...
const char stringsReturn[] PROGMEM = "Powrót";
...
const char stringsJanuary[] PROGMEM = "Styczeñ";
const char stringsFebuary[] PROGMEM = "Luty";
const char stringsMarch[] PROGMEM = "Marzec";
const char stringsApril[] PROGMEM = "Kwiecieñ";
const char stringsMay[] PROGMEM = "Maj";
const char stringsJune[] PROGMEM = "Czerwiec";
const char stringsJuly[] PROGMEM = "Lipiec";
const char stringsAugust[] PROGMEM = "Sierpieñ";
const char stringsSeptember[] PROGMEM = "Wrzesieñ";
const char stringsOctober[] PROGMEM = "PaŸdziernik";
const char stringsNovember[] PROGMEM = "Listopad";
const char stringsDecember[] PROGMEM = "Grudzieñ";

const char stringsSetTime[] PROGMEM = "Ustaw godzinê";
const char stringsSetDate[] PROGMEM = "Ustaw datê";
...
const char stringsBellLength[] PROGMEM = "D³ugoœæ dzwonka";
...
const char stringsForLesson[] PROGMEM = "Na lekcjê";
const char stringsForBreak[] PROGMEM = "Na przerwê";
...
const char stringsProfileShortened[] PROGMEM = "Skrócone";
...
const char stringsClear[] PROGMEM = "Wyczyœæ";
const char stringsDoYouWantToClearBells[] PROGMEM = "Czy na pewno chcesz usun¹æ dzwonki?";
...
const char stringsNoSdCardBottom[] PROGMEM = "spróbuj ponownie";
...
const char stringsNoFilesystemTop[] PROGMEM = "Sformatuj kartê";
...
const char stringsSdCardLoadSuccessBottom[] PROGMEM = "pomyœlnie";
...
const char stringsLoadSdCardSettings[] PROGMEM = "Odczytaj z karty pamiêci";
const char stringsSaveSdCardSettings[] PROGMEM = "Zapisz na kartê pamiêci";
const char stringsFactorySettings[] PROGMEM = "Przywróæ fabryczne";

const char stringsDoYouWantLoadFromSdCard[] PROGMEM = "Czy na pewno chcesz odczytaæ ustawienia z karty SD?";
const char stringsDoYouWantSaveToSdCard[] PROGMEM = "Czy na pewno chcesz zapisaæ ustawienia na kartê SD?";
const char stringsDoYouWantFactorySettings[] PROGMEM = "Czy na pewno chcesz wyczyœciæ wszystkie ustawienia?";
