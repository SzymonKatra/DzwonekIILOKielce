...
// ===========================================================================
// - implemented dly_100us as relay to _delay_us(100) (implementation in asmfunc.S causes compilation errors)
// - copied disk_writep from another example
// - added fragment (finalize writing) to disk_initialize also copied from another example
...
#define MMC_SEL (SDCARD_CS_DDR & (1 << SDCARD_CS_BIT))
...
void dly_100us (void);		/* Delay 100 microseconds (here, asmfunc.S causes errors) */
